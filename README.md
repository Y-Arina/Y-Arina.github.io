...
Работа ведется в команде DWIX. Ссылки на репозиторий проекта, web-страницу и распределенные ролей в команде будут опубликованы после окончания разработки.<br>
